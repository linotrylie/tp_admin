<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:77:"D:\work\test\tp_model\public/../application/admin\view\admin_group\index.html";i:1542355448;s:73:"D:\work\test\tp_model\public/../application/admin\view\template\base.html";i:1488957233;s:84:"D:\work\test\tp_model\public/../application/admin\view\template\javascript_vars.html";i:1488957233;s:76:"D:\work\test\tp_model\public/../application/admin\view\admin_group\form.html";i:1488957233;s:74:"D:\work\test\tp_model\public/../application/admin\view\admin_group\th.html";i:1488957233;s:74:"D:\work\test\tp_model\public/../application/admin\view\admin_group\td.html";i:1488957233;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<td><?php echo get_status($vo['status']); ?></td>
            ...
            <td class="f-14">
                <?php echo show_status($vo['status'],$vo['id']); if (\Rbac::AccessCheck('edit')) : ?> <a title="编辑" href="javascript:;" onclick="layer_open('编辑','<?php echo \think\Url::build('edit', ['id' => $vo["id"], ]); ?>')" style="text-decoration:none" class="ml-5"><i class="Hui-iconfont">&#xe6df;</i></a><?php endif; if (\Rbac::AccessCheck('delete')) : ?> <a title="删除" href="javascript:;" onclick="del(this,'<?php echo $vo['id']; ?>','<?php echo \think\Url::build('delete', []); ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a><?php endif; if (\Rbac::AccessCheck('sdelete')) : ?> <a title="删除" href="javascript:;" onclick="del(this,'<?php echo $vo['sort']; ?>','<?php echo \think\Url::build('sdelete', ['sort' => $vo['sort'], ]); ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a><?php endif; ?>
            </td>
        </tr>
